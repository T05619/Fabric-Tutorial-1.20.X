...
public class ModBlocks {
    ...
    public static final Block RUBY_BLOCK = registerBlock("ruby_block",
            new Block(FabricBlockSettings.copyOf(Blocks.IRON_BLOCK).resistance(1200.0f).sounds(BlockSoundGroup.AMETHYST_BLOCK)));
    public static final Block RAW_BLOCK_OF_RUBY = registerBlock("raw_block_of_ruby",
    ...
    public static final Block RAW_BLOCK_OF_SAPPHIRE = registerBlock("raw_block_of_sapphire",
            new Block(FabricBlockSettings.copyOf(Blocks.IRON_BLOCK).sounds(BlockSoundGroup.AMETHYST_BLOCK)));
